...
<body class="bg-body-tertiary">
	...
	<div class="container-sm">
		<main>
			...
			<div class="my-3 py-3">
				<div>
					<form action="pr_update_ok.do" method="post"
						onsubmit="return pr_check()" enctype="multipart/form-data">
						<input type="hidden" name="prFile" value="${pr.prFile}" /> <input
							type="hidden" name="prNo" value="${pr.prNo}" />
						<div class="row g-3">
							<div class="container">
							...
							<div class="col-sm-6">
								<label for="pr_careerLabel" class="form-label">경력(년)</label> <input
									...
									value="${pr.prCareer}" oninput="inputNumberOnly(this)">
