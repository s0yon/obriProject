...
//		noticeVO notview = notService.notice_view(notNo);
	...
	public String qna_write_ok(@RequestParam("formFile") MultipartFile mf,
							 @ModelAttribute qnaVO qna, HttpServletRequest request,
							 Model model) throws Exception {
	...
	public String admin_member_block(@RequestParam("userId") String userId, @RequestParam("pageNum") int pageNum, Model model)
			throws Exception {
	...
	public String admin_member_nonblock(@RequestParam("userId") String userId, @RequestParam("pageNum") int pageNum, Model model)
			throws Exception {
		System.out.println("현재경로:구인게시판삭제");
	...
	public String admin_member_delete(@RequestParam("userId") String userId, @RequestParam("pageNum") int pageNum, Model model)
			throws Exception {
		System.out.println("현재경로:구인게시판삭제");
	...
	public String comm_delete_selected(
			@RequestParam(value = "selectedCommList", required = false) List<Integer> selectedCommList) throws Exception {
