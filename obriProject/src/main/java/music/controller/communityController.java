...
public class communityController {
	...
	public String boardwrite(@RequestParam("com_file1") MultipartFile mf, communityVO community,
...
//	// 글 목록
	...
	public String boardupdate(@RequestParam("com_file1")  MultipartFile mf, 
		...
		if (size > 0) {				 // 첨부파일이 수정된 경우
			...
			if(updateResult == 1) System.out.println("수정성공");
